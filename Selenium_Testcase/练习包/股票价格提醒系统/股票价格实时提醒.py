...
i=1
while i<=1:
    DataNow=tushare.get_realtime_quotes("000001")
    ...
    #print(type(DataNow))
    print(DataNow)
    print("股票名称：", name_1, "当前价格：", price_1, "最高价：", high_1, "最低价：", low_1, "开盘价：", open_1, "成交量：", volumn_1, "成交额:",
          amount_1, "昨日收盘价：", pre_close_1, "日期", timee_1)
